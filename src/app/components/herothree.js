        ...
        <div className="container relative">
            <div className="grid lg:grid-cols-12 md:grid-cols-2 grid-cols-1 items-center mt-6 gap-6 relative">
                <div className="lg:col-span-7 md:me-6">
                    <h4 className="font-semibold lg:leading-normal leading-normal tracking-wide text-4xl lg:text-5xl mb-5">Revolutionizing Your <span className="text-red-500 font-bold">Business</span> with Upcover</h4>
                    ...
                    <div className="relative mt-6 space-x-1">
                        <Link href="" className="h-10 px-6 tracking-wide inline-flex items-center justify-center font-medium rounded-md bg-red-500 text-white">Get Started</Link>
                        <Link href="#!" scroll={false} onClick={() => setOpen(true)} className="size-9 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-base text-center bg-red-500 text-white rounded-full lightbox"><i className="mdi mdi-play text-xl align-middle"></i></Link><small className="text-sm font-medium uppercase align-middle ms-2">Watch Now</small>
                    </div>
                        <ModalVideo
                            channel="youtube"
                ...
                <div className="lg:col-span-5">
                    <div className="relative">
                        ...
                        <div className="overflow-hidden after:content-[''] after:absolute after:h-10 after:w-10 after:bg-red-500/20 after:top-0 after:start-0 after:-z-1 after:rounded-lg after:animate-[spin_10s_linear_infinite]"></div>
                        ...
                        <div className="absolute top-16 md:-end-10 -end-5 p-4 rounded-lg shadow-md dark:shadow-gray-800 bg-white dark:bg-slate-900 w-48 m-3">
                            ...
                            <div className="w-full bg-gray-100 dark:bg-gray-800 rounded-full h-[6px]">
                                <div className="bg-red-500 h-[6px] rounded-full" style={{width: "84%"}}></div>
                            </div>
                        </div>
                    </div>
                </div>
