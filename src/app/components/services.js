                    ...
                    {servicesData.map((item,index)=>{
                        ...
                        return(
                            <div className="group rounded-md shadow dark:shadow-gray-700 relative bg-white dark:bg-slate-900 p-6 overflow-hidden h-fit" key={index}>
                                <div className="flex items-center justify-center size-14 -rotate-45 bg-gradient-to-r from-transparent to-red-500/10 text-red-500 text-center rounded-full group-hover:bg-red-500/10 duration-500">
                                    <Icon className="size-6 rotate-45"></Icon>
                                </div>
        
                                <div className="content mt-6 relative z-1">
                                    <Link href="" className="title text-lg font-semibold hover:text-red-500">{item.title}</Link>
                                ...
                                <div className="absolute bottom-0 -end-16">
                                    <Icon className="size-48 text-red-500 opacity-[0.04] dark:opacity-[0.04] group-hover:opacity-10 duration-500"></Icon>
                                </div>
                            </div>
                        )
                    })}
