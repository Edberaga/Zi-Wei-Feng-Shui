    ...
    return(
        ...
        <div className="container relative flex flex-wrap items-center justify-between">
            <Link className="navbar-brand md:me-8" href="/">
                <Image src='/images/zwy-logo.png' width={111} height={22} className="inline-block dark:hidden" alt=""/>
                <Image src='/images/zwy-logo.png' width={111} height={22} className="hidden dark:inline-block" alt=""/>
            </Link>
